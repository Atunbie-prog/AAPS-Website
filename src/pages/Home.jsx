  ...
  return (
    <>
      ...
      <Hero
        ...
        interval={3000}
        rotatingWords={['Registered.', 'Compliant.', 'Secured.', 'Funded.', 'Protected.', 'Accredited.', 'Incorporated.', 'Regularised.']}
      ...
      <section className="section section--card intro-section">
        <div className="container">
          <p className="intro-section__text prose reveal">{home.intro}</p>
        </div>
      </section>
      ...
      <section className="section section--tint">
        <div className="container">
          ...
          <h2 className="section-heading reveal reveal--delay-1">Built on accreditation and accountability</h2>
      ...
      <section className="section section--card">
        <div className="container">
          ...
          <h2 className="section-heading reveal reveal--delay-1">Services at a Glance</h2>
          <p className="section-sub reveal reveal--delay-2" style={{ marginBottom: '3rem' }}>
      ...
      <section className="section section--card">
        <div className="container closing-section">
          <div className="closing-section__image reveal reveal--left">
            <img
              src={sectionImages.growth}
              alt="Team reviewing business growth documents"
              loading="lazy"
              width="800"
              height="640"
            />
          </div>
          <div className="closing-section__text reveal reveal--delay-2">
      ...
      <section className="section section--card testimonial-section">
        <div className="container">
          <span className="eyebrow reveal">What Clients Say</span>
          <h2 className="section-heading reveal reveal--delay-1" style={{ marginBottom: '2.75rem' }}>
            Testimonials
          </h2>
        </div>
